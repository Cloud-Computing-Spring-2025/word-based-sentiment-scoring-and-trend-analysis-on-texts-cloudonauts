 ...
 */
public class SentimentScoreReducer extends Reducer<SentimentScoreMapper.BookKey, DoubleWritable, Text, DoubleWritable> {
    
    @Override
    public void reduce(SentimentScoreMapper.BookKey key, Iterable<DoubleWritable> values, Context context) 
