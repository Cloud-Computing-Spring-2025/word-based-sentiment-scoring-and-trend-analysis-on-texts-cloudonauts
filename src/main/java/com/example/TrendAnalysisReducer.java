 ...
 */
public class TrendAnalysisReducer extends Reducer<TrendAnalysisMapper.TrendKey, DoubleWritable, Text, Text> {
    ...
    @Override
    public void reduce(TrendAnalysisMapper.TrendKey key, Iterable<DoubleWritable> values, Context context) 
