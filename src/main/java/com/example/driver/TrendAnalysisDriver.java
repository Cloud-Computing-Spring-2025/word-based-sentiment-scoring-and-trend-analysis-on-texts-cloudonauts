 ...
 */
public class TrendAnalysisDriver extends Configured implements Tool {
    ...
    public int run(String[] args) throws Exception {
        ...
        job.setMapOutputKeyClass(TrendAnalysisMapper.TrendKey.class);
    ...
    public static void main(String[] args) throws Exception {
        int exitCode = ToolRunner.run(new TrendAnalysisDriver(), args);
